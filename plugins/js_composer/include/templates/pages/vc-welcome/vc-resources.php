...
<div class="vc_resources-tab changelog">
	<div class="feature-section vc_row">
		...
		<div class="vc_col-xs-6">
			...
			<p><?php printf( esc_html__( 'To get your support related question answered in the fastest timing, please head over to our %ssupport page%s and open Support ticket. To open a support ticket you should have a valid support subscription in case if your support has expired you can %spurchase support extension%s on support.wpbakery.com.', 'js_composer' ), '<a href="http://support.wpbakery.com" target="_blank">', '</a>', '<a href="http://support.wpbakery.com" target="_blank">', '</a>' ); ?></p>

			<p><?php printf( esc_html__( 'Before applying for support please make sure you understand the rules of support and go through all steps described and listed in %sSupport Policy$s in order to get your issues solved as soon as possible.', 'js_composer' ), '<a href="http://go.wpbakery.com/support-policy" target="_blank">', '</a>' ); ?></p>
		</div>
	</div>
</div>
